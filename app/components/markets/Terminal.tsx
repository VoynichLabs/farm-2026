"use client";
/**
 * Author: Claude Fable 5 (prev Claude Opus 4.7 (Bubba) / Claude Opus 4.8)
 * Date: 16-Jul-2026 (orig 21-May-2026; 23-Jun rotating floor; 16-Jul:
 *   "S7 coop cam" copy corrected to "S7 Birdcatraz cam" — the camera moved
 *   to the outdoor compound's water bowl)
    ...
    <main className="min-h-screen bg-[#020805] text-[#cfeede] font-mono text-[13px] selection:bg-[#22e06b] selection:text-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 p-2">
        ...
        <section className={`lg:col-span-4 ${PANEL} flex flex-col`}>
          ...
          <div className="p-3 text-[11px] text-[#9fc7b3] leading-snug flex-1">
            <p className="mb-2">Picks are generated by <span className="text-[#22e06b]">live chickens</span> via computer vision (S7 Birdcatraz cam → qwen3.5-9b VLM → ticker).</p>
      ...
      <footer className="border-t border-[#1f3b2e] bg-black px-3 py-3 text-center">
        <p className="text-[10px] text-[#46a571] tracking-[0.3em] uppercase">
          Powered by chickens · S7 Birdcatraz cam → qwen3.5-9b VLM → conviction · real quotes via stooq ({data.realAsOf}) · Hampton, CT
        </p>
      </footer>
    </main>
  );
